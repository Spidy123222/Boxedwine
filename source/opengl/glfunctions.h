...
GL_FUNCTION(GetPolygonStipple, void, (GLubyte *mask), (p), GLubyte buffer[128];GLboolean b=PIXEL_PACK_BUFFER();GLubyte* p; if(b)p=(GLubyte*)pARG1; else p=buffer;, if (!b) marshalBackub(cpu, ARG1, buffer, 128);,("glGetPolygonStipple"))
...
GL_FUNCTION(PolygonStipple, void, (const GLubyte *mask), (PIXEL_UNPACK_BUFFER()?(GLubyte*)pARG1:marshalub(cpu, ARG1, 128)),,,("glPolygonStipple"))
...
GL_FUNCTION(Lightfv, void, (GLenum light, GLenum pname, const GLfloat* params), (ARG1, ARG2, buffer), GLfloat* buffer = marshalf(cpu, ARG3, glcommon_glLightv_size(ARG2)); , , ("glLightfv light=%s, pname=%s, params=%s", glcommon_glLightv_print_name(ARG1), glcommon_glLightv_print_pname(ARG2), glcommon_glLightv_print_buffer(ARG2, buffer)))
...
GL_FUNCTION(PixelMapfv, void, (GLenum map, GLint mapsize, const GLfloat *values), (ARG1, ARG2, PIXEL_UNPACK_BUFFER()?(GLfloat*)pARG3:marshalf(cpu, ARG3, ARG2)),,,("glPixelMapfv"))
GL_FUNCTION(PixelMapuiv, void, (GLenum map, GLint mapsize, const GLuint *values), (ARG1, ARG2, PIXEL_UNPACK_BUFFER()?(GLuint*)pARG3:marshalui(cpu, ARG3, ARG2)),,,("glPixelMapuiv"))
GL_FUNCTION(PixelMapusv, void, (GLenum map, GLint mapsize, const GLushort *values), (ARG1, ARG2, PIXEL_UNPACK_BUFFER()?(GLushort*)pARG3:marshalus(cpu, ARG3, ARG2)),,,("glPixelMapusv"))
...
GL_FUNCTION(GetPixelMapfv, void, (GLenum map, GLfloat *values), (ARG1, buffer), GLfloat* buffer; GLboolean b = PIXEL_PACK_BUFFER(); if (b) buffer=(GLfloat*)pARG2; else buffer = marshalf(cpu, ARG2, glcommon_glGetPixelMap_size(ARG1));, if (!b) marshalBackf(cpu, ARG2, buffer, glcommon_glGetPixelMap_size(ARG1));,("glGetPixelMapfv"))
GL_FUNCTION(GetPixelMapuiv, void, (GLenum map, GLuint *values), (ARG1, buffer), GLuint* buffer; GLboolean b = PIXEL_PACK_BUFFER(); if (b) buffer=(GLuint*)pARG2; else buffer = (GLuint*)marshali(cpu, ARG2, glcommon_glGetPixelMap_size(ARG1));, if (!b) marshalBacki(cpu, ARG2, (GLint*)buffer, glcommon_glGetPixelMap_size(ARG1));,("glGetPixelMapuiv"))
GL_FUNCTION(GetPixelMapusv, void, (GLenum map, GLushort *values), (ARG1, buffer), GLushort* buffer; GLboolean b = PIXEL_PACK_BUFFER(); if (b) buffer=(GLushort*)pARG2; else buffer = marshalus(cpu, ARG2, glcommon_glGetPixelMap_size(ARG1));, if (!b) marshalBackus(cpu, ARG2, buffer, glcommon_glGetPixelMap_size(ARG1));,("glGetPixelMapusv"))
